function [metrics, field_vars, partial_wave_amplitudes, unnorm_amplitudes] = ...
    ...
    %   some pre-calcualations for parameters such as the number of layers
    %   and the total commulative thickness. After this, there is a single
    ...
    %   wavenumber_vec      - A vector of wavenumbers.          [1/m]
    ...
    %                                 have been normalsied by the amplitude
    ...
    % get the position of each interface, 0 is at the bottom halfspace
    ...
    unnorm_amplitudes = zeros(n_vector, another_length);
    partial_wave_amplitudes = zeros(n_vector, another_length);   
